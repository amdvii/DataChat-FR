"""Petit jeu de données SYNTHÉTIQUE (chiffres inventés) pour tester le code
sans avoir à télécharger les fichiers INSEE."""
...
LIGNES = [
    ...
    (2020, "95127", "Cergy", "95127", "Cergy", 500),  # intra-communal : doit être ignoré
]
